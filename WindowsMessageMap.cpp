...
#define WM_UAHDRAWMENUITEM 0x00092
...
WindowsMessageMap::WindowsMessageMap() :					//NC stands for non client (Title bar, Border, etc...)
															//Client region is everything in the window
	map ({
